Rem
Rem $Header: rdbms/admin/awrrpti.sql /main/12 2013/10/08 16:25:07 arbalakr Exp $
Rem
Rem awrrpti.sql
Rem
...
-- define report_name = 'awrrpt_sqltune.html'
...
select output from table(sys.dbms_workload_repository.awr_report_html( :dbid,
                                                            :inst_num,
                                                            :bid, :eid,
                                                            :rpt_options ));
...
prompt Report written to &dflt_name..
